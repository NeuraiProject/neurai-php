...
This repository contains an implementation of Bitcoin-compatible functionality for Neurai using mostly pure PHP.
...
`composer require neuraiproject/neurai`

## Contributing

All contributions are welcome. Please see [[this page](https://github.com/NeuraiProject/neurai-php/blob/master/CONTRIBUTING.md)] before you get started
